      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-500 mt-0.5">
            Manage subscriber accounts, notification settings, and permissions.
          </p>
        </div>
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      <img 
                        src={userImage} 
                        alt={user.name || "user"} 
                        className="w-12 h-12 object-cover rounded-full bg-zinc-800 shrink-0 border border-zinc-800" 
                      />
