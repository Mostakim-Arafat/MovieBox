...
import Link from "next/link"; // Next.js ব্যবহার করলে Link ইম্পোর্ট করা ভালো
...
export default function TvShowsPreview() {
    ...
    return (
        <section className="w-full bg-white px-4 py-12 dark:bg-neutral-950 sm:px-8 lg:px-12">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-neutral-400">
                            Binge-worthy series to watch
                        </p>
                    </div>

                    {/* এখানে ট্যাগটি ঠিক করা হয়েছে */}
                    <Link
                        href="/tvshows"
