        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block relative">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-56 bg-zinc-950 border border-zinc-800 rounded-lg pl-9 pr-3 py-2 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-rose-500/50 focus:border-rose-500 transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-zinc-800/60">
            <div className="hidden sm:block text-right">
              <p className="text-sm font-semibold text-zinc-200 leading-tight">Admin User</p>
              <p className="text-xs text-zinc-500 leading-tight">admin@moviebox.com</p>
            </div>
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-rose-600 to-rose-800 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-rose-900/20">
              A
            </div>
          </div>
        </div>
